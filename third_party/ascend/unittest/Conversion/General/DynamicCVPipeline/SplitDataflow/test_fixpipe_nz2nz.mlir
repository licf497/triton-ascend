...
// CHECK: hivm.hir.fixpipe {channel_split = true, ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE", ssbuffer.intraDeps = [0 : i32, 1 : i32]} ins([[MM1:%.*]] : tensor<32x32xf32>) outs({{%.*}} : memref<32x32xf32, #hivm.address_space<cbuf>>)
